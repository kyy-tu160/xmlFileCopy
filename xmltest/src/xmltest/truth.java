        	...
        	if (f1.exists()) {
				...
				for (File file : f1list) {
					 FileReader fr1=new FileReader(file); //fr对象 对应f的读出
			        	...
			        	File f3 = new File("D:\\result2\\"+list1[0]+"\\"+file.getName().substring(0, file.getName().indexOf("."))+"\\"+list1[1]+".txt");
			        	File f4 = new File("D:\\result2\\"+list1[0]+"\\"+file.getName().substring(0, file.getName().indexOf("."))+"\\"+list1[2]+".txt");
			        	File f5 = new File("D:\\result2\\"+list1[0]+"\\"+file.getName().substring(0, file.getName().indexOf("."))+"\\"+list1[3]+".txt");
			        	if (!f3.exists()) {
